...
export default function Navbar() {
    ...
    useEffect(() => {
        console.log(Cookies.get("ssoToken"))
    },[token])
        ...
        <>
            {
                ...
                <nav className="bg-white z-10 drop-shadow-2xl p-4 px-32 max-[640px]:px-2 max-[640px]:m-2 text-lg m-5 rounded-md max-[640px]:w-screen text-black">
                    <div className='flex max-[640px]:flex-col'>
                        ...
                        : 
                            <button onClick={() => setClick(true)} className={'pr-4 pl-3 font-montserrat font-semibold px-3 rounded-full text-white bg-violet-600 max-[640px]:w-fit'}><a href="https://ctssso.onrender.com/login?target=https://sso-blog.vercel.app">Login</a></button>
